    ...
    <div className="p-10 min-h-screen bg-black text-white flex flex-col items-center space-y-12">
      ...
      >
        <h1 className="text-6xl font-extrabold flex items-center justify-center gap-4">
          <span className="bg-yellow-500 p-4 rounded-lg text-4xl">☕</span> Learn Java
        </h1>
        <p className="text-gray-400 text-xl">
          Learn Java programming online with our practical course. Solve problems to test your knowledge of basic syntax and object-oriented programming.
        </p>
      ...
      <Link href="/java-insights">  <Button className="mt-6 text-xl px-6 py-3 bg-blue-500 hover:bg-blue-600">Start Learning</Button></Link>
      </motion.div>
      ...
      >
        <h2 className="text-3xl font-bold text-yellow-500">Java with Beginner DSA Roadmap ⚡</h2>
        <div className="space-y-4 mt-6 text-gray-300 text-xl">
          <div className="border-b border-gray-700 pb-3">
            <p className="font-semibold">Learn Java</p>
            <p className="text-lg">2 Courses</p>
          </div>
          <div>
            <p className="font-semibold">Beginner DSA in Java</p>
      ...
      <Button variant="ghost" className="mt-6 text-yellow-400 text-xl flex items-center gap-2">
        View Roadmap <ChevronRight size={24} />
      </Button>
    </Link>
      </motion.div>
    </div>
