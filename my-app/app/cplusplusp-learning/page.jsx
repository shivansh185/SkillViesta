...
export default function CLearningPage() {
  return (
    <div className="p-10 min-h-screen bg-black text-white flex flex-col items-center space-y-12">
      ...
      >
        <h1 className="text-6xl font-extrabold flex items-center justify-center gap-4">
          <span className="bg-blue-500 p-4 rounded-lg text-4xl">🅲</span> Learn C
        </h1>
        <p className="text-gray-400 text-xl">
          Learn C programming online with our practical course. Solve problems to test your knowledge of basic syntax and object-oriented programming.
        </p>
      ...
      >
        <h2 className="text-3xl font-bold text-yellow-500">C with Beginner DSA Roadmap ⚡</h2>
        <div className="space-y-4 mt-6 text-gray-300 text-xl">
          ...
          <div>
            <p className="font-semibold">Beginner DSA in C</p>
